...
<div class="container-fluid">
    ...
    <?php 
        ...
        $order_id = urlencode($this->mod_crypt->Enc_String($order_info['Order_Id']));
    ?>

    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="<?php echo base_url('buyer/'.$user_url.'/orders/edit_id/'.$order_id); ?>" method='POST' enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="mb-3">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <button type="submit" class="btn btn-success btn-block">Finish Editing Assignment</button>
                        </div>
                    </div>
                </form>                     
