                                        ...
                                        <form class="needs-validation" novalidate="" name="chat-form"
                                            ...
                                            <div class="row">
                                                <div class="col mb-2 mb-sm-0">
                                                    <input type="text" class="form-control border-0" placeholder="Enter your text" id="client_msg_box" required="">
                                                ...
                                                <div class="col-sm-auto">
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="d-grid">
                                                            <button type="button" class="btn btn-success chat-send" id="client_send">
