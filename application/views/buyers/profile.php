        ...
        <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="timeline">
                            ...
                            <div class="border rounded mt-2 mb-3">
                                ...
                                <form action="<?php echo base_url('buyer/'.$user_url.'/add_post'); ?>" method='POST' class="comment-area-box">
            ...
            ?>
                        ...
                        <div class="tab-pane" id="settings">
                            ...
                            <!-- File Upload -->
                                <form action="<?php echo base_url('buyer/'.$user_url.'/profile_image'); ?>" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews"
