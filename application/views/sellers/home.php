                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="Number of My Clients">My Clients</h5>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="index.html" class="btn btn-sm btn-link float-end">Export
                                            ...
                                            <div class="timeline-alt pb-0">
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-item-info">
                                                        <a href="#" class="text-info fw-bold mb-1 d-block">You</a>
                                                        <small>Got Paid 100 USD</small>
                                                        <p class="mb-0 pb-2">
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-item-info">
                                                        <a href="#" class="text-primary fw-bold mb-1 d-block">Buyer 2</a>
                                                        <small>Added an attachment
                                                        </small>
                                                        <p class="mb-0 pb-2">
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-item-info">
                                                        <a href="#" class="text-info fw-bold mb-1 d-block">Buyer 2</a>
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-item-info">
                                                        <a href="#" class="text-primary fw-bold mb-1 d-block">Buyer 1</a>
                                                        <small>Sent you a message
