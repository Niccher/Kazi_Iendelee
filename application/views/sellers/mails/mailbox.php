                                                ...
                                                <ul class="email-list">
                                                    <li class="unread">
                                                        <div class="email-sender-info">
                                                            ...
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-title">Lucas Kriebel (via Twitter)</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-subject">Lucas Kriebel (@LucasKriebel) has sent
                                                    ...
                                                    <li>
                                                        <div class="email-sender-info">
                                                            ...
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-title">Randy, me (5)</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-subject">Last pic over my village &nbsp;&ndash;&nbsp;
                                                    ...
                                                    <li>
                                                        <div class="email-sender-info">
                                                            ...
                                                            <span class="star-toggle mdi mdi-star-outline text-warning"></span>
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-title">Andrew Zimmer</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-subject">Mochila Beta: Subscription Confirmed
                                                    ...
                                                    <li class="unread">
                                                        <div class="email-sender-info">
                                                            ...
                                                            <span class="star-toggle mdi mdi-star-outline"></span>
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-title">Infinity HR</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-subject">Sveriges Hetaste sommarjobb &nbsp;&ndash;&nbsp;
                                                    ...
                                                    <li>
                                                        <div class="email-sender-info">
                                                            ...
                                                            <span class="star-toggle mdi mdi-star-outline text-warning"></span>
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-title">Charukaw, me (7)</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-subject">Hey man &nbsp;&ndash;&nbsp; <span
                                                    ...
                                                    <li class="unread">
                                                        <div class="email-sender-info">
                                                            ...
                                                            <span class="star-toggle mdi mdi-star-outline text-warning"></span>
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-title">me, Peter (5)</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-subject">Home again! &nbsp;&ndash;&nbsp; <span
                                                    ...
                                                    <li>
                                                        <div class="email-sender-info">
                                                            ...
                                                            <span class="star-toggle mdi mdi-star-outline"></span>
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-title">Stack Exchange</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-subject">1 new items in your Stackexchange inbox
                                                    ...
                                                    <li>
                                                        <div class="email-sender-info">
                                                            ...
                                                            <span class="star-toggle mdi mdi-star-outline text-warning"></span>
                                                            <a href="<?php echo base_url('reseller/mails/read')?>;" class="email-title">Google Drive Team</a>
                                                        </div>
                                                        <div class="email-content">
                                                            <a href="<?php echo base_url('reseller/mails/read');?>" class="email-subject">You can now use your storage in Google
