                            ...
                            <div class="col-lg-3">
                                <div id="external-events" class="m-t-20">
                                    ...
                                    <div class="external-event bg-warning-lighten text-warning"
                                        ...
                                        <i
                                            class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Issues Raised
                                    </div>
                                            ...
                                            <?php
                                                ...
                                                foreach ($orders_last_5 as $order) {
                                                    ...
                                                    echo '
                                                        <tr>
                                                            <td>
                                                                <h5 class="font-15 mb-1 fw-normal">'.ucfirst(($order["Order_Name"])).'</h5>
                                                                <span class="text-muted font-13">'.$cat.'</span>
                                                            </td>
                                                            <td>'.date('F d',$order["Order_Created"]).'</td>
                                                        </tr>
                                                    ';
                                                }
                                        ?>
