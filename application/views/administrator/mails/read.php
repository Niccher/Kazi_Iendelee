                                        ...
                                        <div class="page-aside-right">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="d-flex mb-3 mt-1">
                                                    <img class="d-flex me-2 rounded-circle" src="<?php echo base_url('assets/images/users/avatar-4.jpg');?>" alt="placeholder image" height="32">
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="card mb-1 shadow-none border">
                                                            <div class="p-2">
                                                                <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                        <img src="<?php echo base_url('assets/images/projects/project-2.jpg');?>" class="avatar-sm rounded" alt="file-image">
                                                                    </div>
                                                                    <div class="col ps-0">
                                                ...
                                                <div class="mt-5">
                                                    <a href="apps-email-read.html" class="btn btn-secondary me-2"><i class="mdi mdi-reply me-1"></i> Reply</a>
                                                    <a href="apps-email-read.html" class="btn btn-light">Forward <i class="mdi mdi-forward ms-1"></i></a>
                                                </div>
